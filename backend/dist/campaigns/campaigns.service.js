...
let CampaignsService = class CampaignsService {
    constructor(campaignModel, influencerModel) {
    ...
    async findCampaignsByInfluencer(influencerId) {
...
exports.CampaignsService = CampaignsService = __decorate([
    ...
    __param(1, (0, mongoose_1.InjectModel)(influencers_schema_1.Influencer.name)),
